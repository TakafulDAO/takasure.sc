...
node scripts/save-funds/interactions/bootstrap_users.js

node scripts/save-funds/interactions/bootstrap_users.js --count 100 --fund 0.01 --deposit 100 --userBatch 10

Use a custom output directory:
node scripts/save-funds/interactions/bootstrap_users.js --outDir ./scripts/save-funds/interactions/users_out

Reuse an existing users JSON (no regen):
node scripts/save-funds/interactions/bootstrap_users.js --usersJson ./scripts/save-funds/interactions/users_out/users_latest.json

Skip refunds:
node scripts/save-funds/interactions/bootstrap_users.js --skipRefund
*/
