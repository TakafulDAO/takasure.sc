...
install :; forge install OpenZeppelin/openzeppelin-contracts@v5.0.2 --no-commit && forge install OpenZeppelin/openzeppelin-contracts-upgradeable@v5.0.2 --no-commit && forge install smartcontractkit/chainlink-brownie-contracts@1.2.0 --no-commit && forge install cyfrin/foundry-devops@0.0.11 --no-commit && forge install foundry-rs/forge-std@v1.9.1 --no-commit
# Update Dependencies
update:; forge update
