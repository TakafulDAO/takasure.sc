...
contract CcipHelperConfig is DeployConstants, Script {
    ...
    function getArbMainnetConfig() public view returns (CCIPNetworkConfig memory arbMainnetCcipConfig) {
    ...
    function getEthMainnetConfig() public view returns (CCIPNetworkConfig memory ethMainnetCcipConfig) {
    ...
    function getArbSepoliaConfig() public view returns (CCIPNetworkConfig memory arbSepoliaCcipConfig) {
    ...
    function getBaseSepoliaConfig() public view returns (CCIPNetworkConfig memory baseSepoliaCcipConfig) {
    ...
    function getEthSepoliaConfig() public view returns (CCIPNetworkConfig memory ethSepoliaCcipConfig) {
    ...
    function getOpSepoliaConfig() public view returns (CCIPNetworkConfig memory opSepoliaCcipConfig) {
