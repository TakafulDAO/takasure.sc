...
contract Upgrade_MemberModule is Test {
    ...
    function testMemberModule_upgrade() public {
        address newImpl = address(new MemberModule());

        vm.prank(operator);
        memberModule.upgradeToAndCall(newImpl, "");
    }
}
