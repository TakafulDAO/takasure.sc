...
contract Upgrade_RevenueModule is Test {
    ...
    function testRevenueModule_upgrade() public {
        address newImpl = address(new RevenueModule());

        vm.prank(operator);
        revenueModule.upgradeToAndCall(newImpl, "");
    }
}
