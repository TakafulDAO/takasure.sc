...
contract ReferralGatewayJoinDaoTest is Test, SimulateDonResponse {
    ...
    function testMustRevertJoinPoolIfTheDaoHasNoAssignedAddressYet() public KYCReferral {
        vm.prank(referral);
    ...
    function testMustRevertJoinPoolIfTheChildIsNotKYC() public KYCReferral referredPrepays {
        vm.prank(daoAdmin);
