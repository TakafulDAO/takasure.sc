...
contract DeploySFUniV3Strategy is Script, DeployConstants {
    function run(IAddressManager addressManager, address vault, int24 tickLower, int24 tickUpper)
        external
        returns (SFUniswapV3Strategy sfUniV3Strategy)
    {
        ...
        address sfUniV3StrategyAddress = UnsafeUpgrades.deployUUPSProxy(
            ...
            abi.encodeCall(
                ...
                (
                    ...
                    0xbE3aD6a5669Dc0B8b12FeBC03608860C31E2eef6, // USDC/USDT pool
