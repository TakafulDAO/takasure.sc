...
/**
 * @title BenefitMultiplierConsumerMockSuccess
 * @author Maikel Ordaz
 * @notice This contract mock a successful response from the benefit multiplier oracle
 */
...
contract BenefitMultiplierConsumerMockSuccess is AccessControl, FunctionsClient {
    ...
    function setBM(uint256 _bm) external {
        bm = _bm;
    }
    ...
    function sendRequest(
        ...
        bytes memory response = abi.encode(bm);
        bytes memory err = "";
