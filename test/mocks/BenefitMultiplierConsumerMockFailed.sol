...
/**
 * @title BenefitMultiplierConsumerMockFailed
 * @author Maikel Ordaz
...
contract BenefitMultiplierConsumerMockFailed is AccessControl, FunctionsClient {
    ...
    function sendRequest(
        ...
        // Call the callback
        fulfillRequest(lastRequestId, response, err);
