...
rule bma_numerator_in_cash_flow_method_is_greater_than_zero(){
    ...
    require(totalClaimReserves > 0 && totalFundReserves > 0 && bmaFundReserveShares > 0 && bmaInflowAssumption > 0);
...
rule bma_denominator_in_cash_flow_method_is_greater_than_zero(){
    ...
    require(totalFundReserves > 0 && bmaFundReserveShares > 0 && proFormaClaimReserve > 0 && (totalFundReserves * bmaFundReserveShares) > 100);
